...
class MoveMapper
{
    public function mapMoves(\App\Entity\Pokemon $pokemon, array $move, \App\Entity\Generation $generation, \Doctrine\Persistence\ObjectManager $em, \App\Entity\MoveLearnMethod $learnMethod)
    {
