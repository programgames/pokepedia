...
class ItemCategory
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=ItemPocket::class, inversedBy="itemCategories")
     */
    private $itemPocket;
    ...
    public function getItemPocket(): ?ItemPocket
    {
        return $this->itemPocket;
    }

    public function setItemPocket(?ItemPocket $itemPocket): self
    {
