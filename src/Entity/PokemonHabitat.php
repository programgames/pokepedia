...
use App\Repository\PokemonHabitatRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=PokemonHabitatRepository::class)
 */
class PokemonHabitat
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=PokemonSpecy::class, mappedBy="pokemonHabitat")
     */
    ...
    public function addPokemonSpecies(PokemonSpecy $pokemonSpecies): self
    {
        if (!$this->pokemonSpecies->contains($pokemonSpecies)) {
            ...
            $pokemonSpecies->setPokemonHabitat($this);
        }
    ...
    public function removePokemonSpecies(PokemonSpecy $pokemonSpecies): self
    {
        if ($this->pokemonSpecies->removeElement($pokemonSpecies)) {
            ...
            if ($pokemonSpecies->getPokemonHabitat() === $this) {
                $pokemonSpecies->setPokemonHabitat(null);
            }
        }
