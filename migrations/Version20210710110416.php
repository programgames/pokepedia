 ...
 */
final class Version20210710110416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT NOT NULL, pokemon_specy_id INT NOT NULL, name VARCHAR(255) NOT NULL, pokemon_order INT NOT NULL, pokemon_identifier INT NOT NULL, to_import BOOLEAN NOT NULL, specific_name VARCHAR(255) DEFAULT NULL, is_alola BOOLEAN NOT NULL, is_galar BOOLEAN NOT NULL, PRIMARY KEY(id))');
