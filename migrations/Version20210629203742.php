 ...
 */
final class Version20210629203742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE leveling_up_move (id INT NOT NULL, pokemon_id INT NOT NULL, move VARCHAR(255) NOT NULL, level INT DEFAULT NULL, type VARCHAR(255) NOT NULL, attack_type VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, power INT DEFAULT NULL, accuracy INT DEFAULT NULL, power_points INT NOT NULL, form VARCHAR(255) DEFAULT NULL, generation INT NOT NULL, crystal BOOLEAN DEFAULT NULL, fire_red BOOLEAN DEFAULT NULL, leaf_green BOOLEAN DEFAULT NULL, emerald BOOLEAN DEFAULT NULL, diamond BOOLEAN DEFAULT NULL, pearl BOOLEAN DEFAULT NULL, platinum BOOLEAN DEFAULT NULL, heart_gold BOOLEAN DEFAULT NULL, soul_silver BOOLEAN NOT NULL, black BOOLEAN DEFAULT NULL, white BOOLEAN DEFAULT NULL, black2 BOOLEAN DEFAULT NULL, white2 BOOLEAN DEFAULT NULL, x BOOLEAN DEFAULT NULL, y BOOLEAN DEFAULT NULL, omega_ruby BOOLEAN DEFAULT NULL, omega_sapphire BOOLEAN DEFAULT NULL, sun BOOLEAN DEFAULT NULL, moon BOOLEAN DEFAULT NULL, ultra_moon BOOLEAN DEFAULT NULL, ultra_sun BOOLEAN DEFAULT NULL, sword BOOLEAN DEFAULT NULL, shield BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tutoring_move (id INT NOT NULL, pokemon_id INT NOT NULL, move VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, attack_type VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, power INT DEFAULT NULL, accuracy INT NOT NULL, power_points INT NOT NULL, form VARCHAR(255) DEFAULT NULL, generation INT NOT NULL, crystal BOOLEAN DEFAULT NULL, fire_red BOOLEAN DEFAULT NULL, leaf_green BOOLEAN DEFAULT NULL, emerald BOOLEAN DEFAULT NULL, diamond BOOLEAN DEFAULT NULL, pearl BOOLEAN DEFAULT NULL, platinum BOOLEAN DEFAULT NULL, heart_gold BOOLEAN DEFAULT NULL, soul_silver BOOLEAN NOT NULL, black BOOLEAN DEFAULT NULL, white BOOLEAN DEFAULT NULL, black2 BOOLEAN DEFAULT NULL, white2 BOOLEAN DEFAULT NULL, x BOOLEAN DEFAULT NULL, y BOOLEAN DEFAULT NULL, omega_ruby BOOLEAN DEFAULT NULL, omega_sapphire BOOLEAN DEFAULT NULL, sun BOOLEAN DEFAULT NULL, moon BOOLEAN DEFAULT NULL, ultra_moon BOOLEAN DEFAULT NULL, ultra_sun BOOLEAN DEFAULT NULL, sword BOOLEAN DEFAULT NULL, shield BOOLEAN NOT NULL, PRIMARY KEY(id))');
